# @morgan.rebrand/agents-statusline-linux-x64

Prebuilt [agents-statusline](https://github.com/callmemorgan/agents-statusline) binary for **Linux on x86-64** (linux/x64).
...
```bash
npm i -g @morgan.rebrand/agents-statusline-linux-x64
```
