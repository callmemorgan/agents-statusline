# @morgan.rebrand/agents-statusline-win32-x64

Prebuilt [agents-statusline](https://github.com/callmemorgan/agents-statusline) binary for **Windows on x64** (win32/x64).
...
```bash
npm i -g @morgan.rebrand/agents-statusline-win32-x64
```
