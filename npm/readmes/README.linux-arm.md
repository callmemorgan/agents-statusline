# @morgan.rebrand/agents-statusline-linux-arm

Prebuilt [agents-statusline](https://github.com/callmemorgan/agents-statusline) binary for **Linux on 32-bit ARM** (linux/arm, ARMv7).
...
```bash
npm i -g @morgan.rebrand/agents-statusline-linux-arm
```
