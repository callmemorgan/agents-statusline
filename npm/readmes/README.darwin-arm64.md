# @morgan.rebrand/agents-statusline-darwin-arm64

Prebuilt [agents-statusline](https://github.com/callmemorgan/agents-statusline) binary for **macOS on Apple Silicon** (darwin/arm64).
...
```bash
npm i -g @morgan.rebrand/agents-statusline-darwin-arm64
```
