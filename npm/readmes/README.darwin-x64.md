# @morgan.rebrand/agents-statusline-darwin-x64

Prebuilt [agents-statusline](https://github.com/callmemorgan/agents-statusline) binary for **macOS on Intel** (darwin/x64).
...
```bash
npm i -g @morgan.rebrand/agents-statusline-darwin-x64
```
