...
func SamplePayload() Payload {
	...
	return Payload{
		...
		Workspace: Workspace{
			...
			Repo:        Repo{Host: "github.com", Owner: "callmemorgan", Name: "agents-statusline"},
		},
		OutputStyle: OutputStyle{Name: "Explanatory"},
		Email:       "you@example.com",
		Thinking:    Thinking{Enabled: &trueVal},
		PR:          PR{Number: 42, URL: "https://github.com/callmemorgan/agents-statusline/pull/42", ReviewState: "pending"},
		Cost: Cost{
			TotalCostUSD:      0.42,
			TotalLinesAdded:   128,
